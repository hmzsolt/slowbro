...
client.on("message", (message) => {
  ...
  if (message.content.startsWith(prefix + "red")) {
    ...
    message.react(client.emojis.get(":white_check_mark:")).then().catch(console.error);
    message.react(client.emojis.get(":negative_squared_cross_mark:")).then().catch(console.error);  
  } 
